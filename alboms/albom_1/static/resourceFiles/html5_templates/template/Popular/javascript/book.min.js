...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(v,t){return"function"==typeof v?function(u){try{m(v(u))}catch(r){p(r)}}:t}var m,p,q=new f(function(v,t){m=v;p=t});this.callWhenSettled_(l(h,m),l(k,p));return q};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
p){function q(u){return function(r){v[u]=r;t--;0==t&&m(v)}}var v=[],t=0;do v.push(void 0),t++,d(l.value).callWhenSettled_(q(v.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
fliphtml5Url="http://www.fliphtml5.com",baiduUrl="https://hm.baidu.com/hm.js";/*
...
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,x,y){x=x.prototype;var B=n.prototype=Object.create(x);B.constructor=n;B._super=x;y&&Z(B,y)}function m(n,x){return function(){return n.apply(x,arguments)}}function p(n,x){return"function"==typeof n?n.apply(x?x[0]||e:e,x):n}function q(n,x,y){h(u(x),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,y,!1):n.attachEvent(B,y)})}
function v(n,x,y){h(u(x),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,y,!1):n.detachEvent(B,y,!1)})}function t(n,x){for(;n;){if(n==x)return!0;n=n.parentNode}return!1}function u(n){return n.trim().split(/\s+/g)}function r(n,x,y){if(n.indexOf&&!y)return n.indexOf(x);for(var B=0;B<n.length;){if(y&&n[B][y]==x||!y&&n[B]===x)return B;B++}return-1}function w(n){return Array.prototype.slice.call(n,0)}function z(n,x,y){for(var B=[],C=[],E=0;E<n.length;){var H=x?n[E][x]:n[E];
0>r(C,H)&&B.push(n[E]);C[E]=H;E++}y&&(B=x?B.sort(function(N,V){return N[x]>V[x]}):B.sort());return B}function A(n,x){if(x&&x[0]){for(var y,B=x[0].toUpperCase()+x.slice(1),C=0;C<sa.length;){y=(y=sa[C])?y+B:x;if(y in n)return y;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,x){var y=this;this.manager=n;this.callback=x;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){p(n.options.enable,[n])&&y.handler(B)};this.init()}
function L(n,x,y){var B=y.pointers.length,C=y.changedPointers.length;var E=x&1&&0===B-C;y.isFirst=!!E;y.isFinal=!!(x&12&&0===B-C);E&&(n.session={});y.eventType=x;x=n.session;B=y.pointers;C=B.length;x.firstInput||(x.firstInput=M(y));1<C&&!x.firstMultiple?x.firstMultiple=M(y):1===C&&(x.firstMultiple=!1);E=x.firstInput;var H=(C=x.firstMultiple)?C.center:E.center;var N=y.center=I(B);y.timeStamp=qa();y.deltaTime=y.timeStamp-E.timeStamp;y.angle=K(H,N);y.distance=O(H,N);E=y.center;H=x.offsetDelta||{};N=
...
x.prevInput?y.pointers.length>x.prevInput.maxPointers?y.pointers.length:x.prevInput.maxPointers:y.pointers.length;H=x.lastInterval||y;B=y.timeStamp-H.timeStamp;8!=y.eventType&&(25<B||H.velocity===e)?(E=y.deltaX-H.deltaX,H=y.deltaY-H.deltaY,N=E/B||0,V=H/B||0,B=N,C=V,N=da(N)>da(V)?N:V,E=G(E,H),x.lastInterval=y):(N=H.velocity,B=H.velocityX,C=H.velocityY,E=H.direction);y.velocity=N;y.velocityX=B;y.velocityY=C;y.direction=E;x=n.element;t(y.srcEvent.target,x)&&(x=y.srcEvent.target);y.target=x;n.emit("hammer.input",
y);n.recognize(y);n.session.prevInput=y}function M(n){for(var x=[],y=0;y<n.pointers.length;)x[y]={clientX:ha(n.pointers[y].clientX),clientY:ha(n.pointers[y].clientY)},y++;return{timeStamp:qa(),pointers:x,center:I(x),deltaX:n.deltaX,deltaY:n.deltaY}}function I(n){var x=n.length;if(1===x)return{x:ha(n[0].clientX),y:ha(n[0].clientY)};for(var y=0,B=0,C=0;C<x;)y+=n[C].clientX,B+=n[C].clientY,C++;return{x:ha(y/x),y:ha(B/x)}}function G(n,x){return n===x?1:da(n)>=da(x)?0>n?2:4:0>x?8:16}function O(n,x,y){y||
(y=ta);var B=x[y[0]]-n[y[0]];n=x[y[1]]-n[y[1]];return Math.sqrt(B*B+n*n)}function K(n,x,y){y||(y=ta);return 180*Math.atan2(x[y[1]]-n[y[1]],x[y[0]]-n[y[0]])/Math.PI}function J(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;D.apply(this,arguments)}function Q(){this.evEl=ua;this.evWin=va;D.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function U(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;D.apply(this,arguments)}function T(){this.evTarget=
Ca;this.targetIds={};D.apply(this,arguments)}function S(n,x){var y=w(n.touches),B=this.targetIds;if(x&3&&1===y.length)return B[y[0].identifier]=!0,[y,y];n=w(n.changedTouches);var C=[],E=this.target;var H=y.filter(function(N){return t(N.target,E)});if(1===x)for(y=0;y<H.length;)B[H[y].identifier]=!0,y++;for(y=0;y<n.length;)B[n[y].identifier]&&C.push(n[y]),x&12&&delete B[n[y].identifier],y++;if(C.length)return[z(H.concat(C),"identifier",!0),C]}function ia(){D.apply(this,arguments);var n=m(this.handler,
...
process:function(n){var x=this.state,y=n.eventType,B=x&6;n=this.attrTest(n);return B&&(y&8||!n)?x|16:B||n?y&4?x|8:x&2?x|4:2:32}});l(fa,R,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,x=[];n&6&&x.push("pan-y");n&24&&x.push("pan-x");return x},directionTest:function(n){var x=this.options,y=!0,B=n.distance,C=n.direction,E=n.deltaX,H=n.deltaY;C&x.direction||(x.direction&6?(C=0===E?1:0>E?2:4,y=E!=this.pX,B=Math.abs(n.deltaX)):(C=0===
H?1:0>H?8:16,y=H!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return y&&B>x.threshold&&C&x.direction},attrTest:function(n){return R.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var x=na(n.direction);x&&(n.additionalEvent=this.options.event+x);this._super.emit.call(this,n)}});l(ka,R,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(ba,P,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var x=this.options,y=n.pointers.length===x.pointers,B=n.distance<x.threshold,C=n.deltaTime>x.time;this._input=n;if(!B||!y||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),
...
n.eventType&4},emit:function(n){var x=na(n.offsetDirection);x&&this.manager.emit(this.options.event+x,n);this.manager.emit(this.options.event,n)}});l(la,P,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var x=this.options,y=n.pointers.length===x.pointers,B=n.distance<x.threshold,C=n.deltaTime<x.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&y){if(4!=
...
ra.prototype={set:function(n){Z(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var x=this.session;if(!x.stopped){this.touchAction.preventDefaults(n);var y=this.recognizers,B=x.curRecognizer;if(!B||B&&B.state&8)B=x.curRecognizer=null;for(var C=0;C<y.length;){var E=y[C];2===x.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=x.curRecognizer=E);C++}}},get:function(n){if(n instanceof P)return n;for(var x=this.recognizers,y=0;y<x.length;y++)if(x[y].options.event==n)return x[y];return null},add:function(n){if(g(n,"add",this))return this;var x=this.get(n.options.event);x&&this.remove(x);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var x=this.recognizers;n=r(x,n);-1!==n&&(x.splice(n,1),this.touchAction.update())}return this},
on:function(n,x){if(n!==e&&x!==e){var y=this.handlers;h(u(n),function(B){y[B]=y[B]||[];y[B].push(x)});return this}},off:function(n,x){if(n!==e){var y=this.handlers;h(u(n),function(B){x?y[B]&&y[B].splice(r(y[B],x),1):delete y[B]});return this}},emit:function(n,x){this.options.domEvents&&Ea(n,x);var y=this.handlers[n]&&this.handlers[n].slice();if(y&&y.length)for(x.type=n,x.preventDefault=function(){x.srcEvent.preventDefault()},n=0;n<y.length;)y[n](x),n++},destroy:function(){this.element&&wa(this,!1);
...
f.animateInterval.stop();f.parameters.zoomFlag=!1;f.parameters.zoomOut=!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,p=0,q=0;f.animateInterval=function(v,t){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,
f.parameters.height*(g-1),20);p=$.easing.swing(null,m,f.parameters.left,f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);q=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:p+"px",top:q+"px"});for(var u=0;u<f.side.pageArray.length;u++)if(f.side.pageArray[u])f.side.pageArray[u].onResize(k/2,l);m++;if(20<=m||v>=t){f.animateInterval.stop();
f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100;f.parameters.top=f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100;f.parameters.width*=g;f.parameters.height*=g;f.css({width:f.parameters.width+"px",height:f.parameters.height+"px",left:f.parameters.left+"px",top:f.parameters.top+"px"});for(u=0;u<f.side.pageArray.length;u++)if(f.side.pageArray[u])f.side.pageArray[u].onResize(f.parameters.width/2,f.parameters.height);f.parameters.zoomming=
...
100;var p=e*h,q=e*k,v=0,t=0,u=0,r=0;toolBar&&(v=0===toolBar.getTopHeight()?0:toolBar.getTopHeight()+10,t=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,u=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,r=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(p>windowWidth){var w=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-r;l=-l-h*e*d.parameters.zoomArea.left/100+u}else w=-l-h*e*d.parameters.zoomArea.left/100+u,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100-
r;q>windowHeight?(h=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-t,d=-m-k*e*d.parameters.zoomArea.top/100+v):(h=-m-k*e*d.parameters.zoomArea.top/100+v,d=windowHeight-q-m+k*e*d.parameters.zoomArea.bottom/100-t);g=Number.between(g,w,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,
...
$(this).width();this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,q){m(p,q,"Sine")}).animation(this,300)}.bind(this),m=function(p,q,v){if(p<q){v=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,q);var t=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,q);p=k(null,p,this.parameters.scale,d-this.parameters.scale,q);q={};q.scale=
p;q.tran={x:v,y:t};v=transformCSS(q);this.css(v)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),p=getHost();if(m&&p!==m){if(g=f.src.replace(m,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(r){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var q=h.getImageData(0,0,k,l),v=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&q){var t=Color(b).split();k=0;for(var u=q.data.length;k<u;k+=4)0<v.data[k+3]&&(q.data[k]!=t.r&&(v.data[k]=q.data[k]/255*t.r),q.data[k+1]!=t.g&&(v.data[k+1]=
q.data[k+1]/255*t.g),q.data[k+2]!=t.b&&(v.data[k+2]=q.data[k+2]/255*t.b));h.putImageData(v,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(r){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(w){}})}}}}};
...
!0;m=new Date;u=(m-l)/20;var r=h-f,w=k-g;0==u?t=v=0:(v=r/u,t=w/u);void 0!=b&&b(v,t);window.clearInterval(p);p=-1}var f,g,h,k,l,m,p=-1,q=!1,v=0,t=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(u){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(u){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",p=-1,q,v,t,u=k.length-l;++p<u;)q=k.charCodeAt(p)<<
16,v=k.charCodeAt(++p)<<8,t=k.charCodeAt(++p),q=q+v+t,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q&63);2==l?(q=k.charCodeAt(p)<<8,v=k.charCodeAt(++p),q+=v,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<2&63)+"="):1==l&&(q=k.charCodeAt(p),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(q<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,p,q,v="",t=-1;++t<l;)q="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(t)),
...
(function(b){function c(t,u){var r=(t&65535)+(u&65535);return(t>>16)+(u>>16)+(r>>16)<<16|r&65535}function d(t,u,r,w,z,A){t=c(c(u,t),c(w,A));return c(t<<z|t>>>32-z,r)}function e(t,u,r,w,z,A,F){return d(u&r|~u&w,t,u,z,A,F)}function f(t,u,r,w,z,A,F){return d(u&w|r&~w,t,u,z,A,F)}function g(t,u,r,w,z,A,F){return d(r^(u|~w),t,u,z,A,F)}function h(t,u){t[u>>5]|=128<<u%32;t[(u+64>>>9<<4)+14]=u;var r=1732584193,w=-271733879,z=-1732584194,A=271733878;for(u=0;u<t.length;u+=16){var F=r;var D=w;var L=z;var M=A;
r=e(r,w,z,A,t[u],7,-680876936);A=e(A,r,w,z,t[u+1],12,-389564586);z=e(z,A,r,w,t[u+2],17,606105819);w=e(w,z,A,r,t[u+3],22,-1044525330);r=e(r,w,z,A,t[u+4],7,-176418897);A=e(A,r,w,z,t[u+5],12,1200080426);z=e(z,A,r,w,t[u+6],17,-1473231341);w=e(w,z,A,r,t[u+7],22,-45705983);r=e(r,w,z,A,t[u+8],7,1770035416);A=e(A,r,w,z,t[u+9],12,-1958414417);z=e(z,A,r,w,t[u+10],17,-42063);w=e(w,z,A,r,t[u+11],22,-1990404162);r=e(r,w,z,A,t[u+12],7,1804603682);A=e(A,r,w,z,t[u+13],12,-40341101);z=e(z,A,r,w,t[u+14],17,-1502002290);
w=e(w,z,A,r,t[u+15],22,1236535329);r=f(r,w,z,A,t[u+1],5,-165796510);A=f(A,r,w,z,t[u+6],9,-1069501632);z=f(z,A,r,w,t[u+11],14,643717713);w=f(w,z,A,r,t[u],20,-373897302);r=f(r,w,z,A,t[u+5],5,-701558691);A=f(A,r,w,z,t[u+10],9,38016083);z=f(z,A,r,w,t[u+15],14,-660478335);w=f(w,z,A,r,t[u+4],20,-405537848);r=f(r,w,z,A,t[u+9],5,568446438);A=f(A,r,w,z,t[u+14],9,-1019803690);z=f(z,A,r,w,t[u+3],14,-187363961);w=f(w,z,A,r,t[u+8],20,1163531501);r=f(r,w,z,A,t[u+13],5,-1444681467);A=f(A,r,w,z,t[u+2],9,-51403784);
z=f(z,A,r,w,t[u+7],14,1735328473);w=f(w,z,A,r,t[u+12],20,-1926607734);r=d(w^z^A,r,w,t[u+5],4,-378558);A=d(r^w^z,A,r,t[u+8],11,-2022574463);z=d(A^r^w,z,A,t[u+11],16,1839030562);w=d(z^A^r,w,z,t[u+14],23,-35309556);r=d(w^z^A,r,w,t[u+1],4,-1530992060);A=d(r^w^z,A,r,t[u+4],11,1272893353);z=d(A^r^w,z,A,t[u+7],16,-155497632);w=d(z^A^r,w,z,t[u+10],23,-1094730640);r=d(w^z^A,r,w,t[u+13],4,681279174);A=d(r^w^z,A,r,t[u],11,-358537222);z=d(A^r^w,z,A,t[u+3],16,-722521979);w=d(z^A^r,w,z,t[u+6],23,76029189);r=d(w^
z^A,r,w,t[u+9],4,-640364487);A=d(r^w^z,A,r,t[u+12],11,-421815835);z=d(A^r^w,z,A,t[u+15],16,530742520);w=d(z^A^r,w,z,t[u+2],23,-995338651);r=g(r,w,z,A,t[u],6,-198630844);A=g(A,r,w,z,t[u+7],10,1126891415);z=g(z,A,r,w,t[u+14],15,-1416354905);w=g(w,z,A,r,t[u+5],21,-57434055);r=g(r,w,z,A,t[u+12],6,1700485571);A=g(A,r,w,z,t[u+3],10,-1894986606);z=g(z,A,r,w,t[u+10],15,-1051523);w=g(w,z,A,r,t[u+1],21,-2054922799);r=g(r,w,z,A,t[u+8],6,1873313359);A=g(A,r,w,z,t[u+15],10,-30611744);z=g(z,A,r,w,t[u+6],15,-1560198380);
w=g(w,z,A,r,t[u+13],21,1309151649);r=g(r,w,z,A,t[u+4],6,-145523070);A=g(A,r,w,z,t[u+11],10,-1120210379);z=g(z,A,r,w,t[u+2],15,718787259);w=g(w,z,A,r,t[u+9],21,-343485551);r=c(r,F);w=c(w,D);z=c(z,L);A=c(A,M)}return[r,w,z,A]}function k(t){var u,r="",w=32*t.length;for(u=0;u<w;u+=8)r+=String.fromCharCode(t[u>>5]>>>u%32&255);return r}function l(t){var u,r=[];r[(t.length>>2)-1]=void 0;for(u=0;u<r.length;u+=1)r[u]=0;var w=8*t.length;for(u=0;u<w;u+=8)r[u>>5]|=(t.charCodeAt(u/8)&255)<<u%32;return r}function m(t){return k(h(l(t),
8*t.length))}function p(t,u){var r=l(t),w=[],z=[];w[15]=z[15]=void 0;16<r.length&&(r=h(r,8*t.length));for(t=0;16>t;t+=1)w[t]=r[t]^909522486,z[t]=r[t]^1549556828;u=h(w.concat(l(u)),512+8*u.length);return k(h(z.concat(u),640))}function q(t){var u="",r;for(r=0;r<t.length;r+=1){var w=t.charCodeAt(r);u+="0123456789abcdef".charAt(w>>>4&15)+"0123456789abcdef".charAt(w&15)}return u}function v(t,u,r){u?r?t=p(unescape(encodeURIComponent(u)),unescape(encodeURIComponent(t))):(t=p(unescape(encodeURIComponent(u)),
unescape(encodeURIComponent(t))),t=q(t)):t=r?m(unescape(encodeURIComponent(t))):q(m(unescape(encodeURIComponent(t))));return t}"function"===typeof define&&define.amd?define(function(){return v}):"object"===typeof module&&module.exports?module.exports=v:b.md5=v})(this);String.prototype.MD5=function(b){return md5(this)};
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this;k=d(h);var m=void 0!==k&&null!==k?k:"__default__";e[m]&&clearTimeout(e[m]);return new Promise(function(p,q){f[m]||(f[m]=[]);f[m].push({resolve:p,reject:q});e[m]=setTimeout(function(){var v,t,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){switch(r.nextAddress){case 1:return v=f[m],r.setCatchFinallyBlocks(2,3),r.yield(b.apply(l,
h),5);case 5:t=r.yieldResult,v&&v.forEach(function(w){return w.resolve(t)});case 3:r.enterFinallyBlock();delete e[m];delete f[m];r.leaveFinallyBlock(0);break;case 2:u=r.enterCatchBlock(),v&&v.forEach(function(w){return w.reject(u)}),r.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d",{willReadFrequently:!0});l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var p=m.getImageData(0,0,l.width,l.height),q=p.data,v=c?e(c):null,t=d?e(d):{r:0,g:0,b:0,a:0},u=0;u<q.length;u+=4){var r=q[u+3];0===r?(q[u]=t.r,q[u+1]=t.g,q[u+2]=t.b,q[u+3]=void 0!==t.a?t.a:0):0<r&&255>r?v&&(q[u]=Math.round((v.r*r+t.r*(255-r))/255),q[u+1]=Math.round((v.g*r+t.g*(255-r))/255),q[u+2]=Math.round((v.b*r+t.b*(255-r))/255),
q[u+3]=255):v&&(q[u]=v.r,q[u+1]=v.g,q[u+2]=v.b,q[u+3]=void 0!==v.a?v.a:255)}m.putImageData(p,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
...
(function(b){function c(){null==b.pageTextPositions&&(b.pageTextPositions=[]);return b.pageTextPositions}function d(q,v){var t=c();try{var u=v&&"object"===typeof v?Object.assign({},v):v;if(u&&"object"===typeof u){u.page=Number(q+1);var r=t[q];r&&r.positions&&u.positions?u.positions=r.positions.concat(u.positions):r&&r.positions&&(u.positions=r.positions);null!=l?u.realPage=Number(l):r&&r.realPage&&(u.realPage=r.realPage);r&&Object.keys(r).forEach(function(w){"page"===w||"realPage"===w||"positions"===
w||w in u||(u[w]=r[w])})}t[q]=u;return!0}catch(w){return console.error("writeToTarget error",w),!1}}function e(q,v,t){if(!q||0===q.length)return null;for(var u=q[0].left,r=q[0].top,w=q[0].right,z=q[0].bottom,A="",F=0;F<q.length;F++){var D=q[F];u=Math.min(u,D.left);r=Math.min(r,D.top);w=Math.max(w,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=u/v;r/=t;w/=v;t=z/t;t=[F,t,w,t,w,r,F,r];z=[];for(F=0;F<q.length;F++)z.push(q[F].width/v);if(!A||0===A.trim().length)return null;q=t.concat(z);return{w:A,p:q}}
function f(q){b._pageReaderExtracted||(b._pageReaderExtracted={});q=Array.isArray(q)?q:[q];for(var v=0,t=0;t<q.length;t++){var u=q[t];if(u&&!(1>u)&&!b._pageReaderExtracted[u])if(b._pageReaderExtracted[u]=!0,window._getPage&&"function"===typeof window._getPage)try{var r=window._getPage(u-1);if(r){var w=null;if(r.items&&Array.isArray(r.items)){w=r.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<w.length;D++){var L=w[D];if(L&&"text"===L.type&&
L.positionText&&L.style){var M=L,I=u,G=z,O=A,K=c();b.pageTextPositions||(b.pageTextPositions=[]);var J=M;if(J&&J.positionText&&J.style){M=[];var Q=parseFloat(J.style.left)||0,U=parseFloat(J.style.top)||0,T=J.positionText;for(J=0;J<T.length;J++){var S=T[J];if(S&&S.rowText&&0!==S.rowText.length){for(var ia=S.rowText,W=[],ea=null,ma=0;ma<ia.length;ma++){var P=ia[ma];if(P&&P.text){var ja=Q+(P.left||0),na=U+(P.top||0),aa=P.width||0,R=P.height||0,fa=ja+aa,ka=!1;null!==ea&&ja-ea>.5*aa&&(ka=!0);if(ka&&0<
...
(u-1)+")"):console.log("PageTextExtractor: \u9875\u9762 "+(u-1)+" \u4e2d\u6ca1\u6709\u627e\u5230\u6587\u672c\u5143\u7d20")}else console.warn("PageTextExtractor: \u9875\u9762\u6570\u636e\u683c\u5f0f\u4e0d\u6b63\u786e\uff0c\u671f\u671b {items: [...]}")}else console.warn("PageTextExtractor: \u65e0\u6cd5\u83b7\u53d6\u9875\u9762 "+(u-1)+" \u7684\u6570\u636e")}catch(la){b._pageReaderExtracted[u]=!1,console.error("PageTextExtractor: \u63d0\u53d6\u9875\u9762 "+(u-1)+" \u7684\u6587\u672c\u914d\u7f6e\u65f6\u51fa\u9519",
la)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return v}function g(q){var v,t,u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){if(!q||1>q)return r.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});b._positionScriptLoadPromises||(b._positionScriptLoadPromises={});v=b.getSearchRealPageIndex(q);if(0>=v||-1===v||b._positionScriptLoaded[v])return r.return(!1);if(t=b._positionScriptLoadPromises[v])return r.return(t);
u=function(){var w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:return D.setCatchFinallyBlocks(2,3),w=String.format(bookConfig.searchPositionJS,v),1<v&&(w=w.replace("[1]","["+v+"]")),z=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi,A=/\.*\/?(\w+\/)*\w+?\.js/gi,w.match(z)||w.match(A)?D.yield(getArticleImage(fixURLValue(w)),5):D.return(!1);case 5:return(w=D.yieldResult)?D.yield(h(q,w,v),6):D.return(!1);case 6:return b._positionScriptLoaded[v]=!0,D.return(!0);
case 3:D.enterFinallyBlock();delete b._positionScriptLoadPromises[v];D.leaveFinallyBlock(0);break;case 2:return F=D.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",F),D.return(!1)}})}();b._positionScriptLoadPromises[v]=u;return r.return(u)})}function h(q,v,t){var u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){u=function(){var w,z,A,F,D,L,M,I;return $jscomp.asyncExecutePromiseGeneratorProgram(function(G){switch(G.nextAddress){case 1:k=q;l=t;if(w=
...
v;J.onload=function(){setTimeout(function(){l=k=null;O()},0)};J.onerror=function(Q){l=k=null;console.log("Script load failed:",v,Q);K(Error("Script load failed: "+v))};J.src=v;I.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),G.return())}})};m=m.then(function(){return u()}).catch(function(w){console.log("queue error:",w&&w.message)});return r.return(m)})}"undefined"!==typeof b&&null==b.pageTextPositions&&(b.pageTextPositions=[]);var k=null,
l=null,m=Promise.resolve(),p=new Proxy({},{get:function(q,v){var t=c();return"string"===typeof v&&/^\d+$/.test(v)?t[Number(v)]:"length"===v?t.length:"function"===typeof Array.prototype[v]?Array.prototype[v].bind(t):q[v]},set:function(q,v,t){return"string"===typeof v&&/^\d+$/.test(v)?(q=Number(v),null!=k?d(k-1,t):d(q,t),!0):!1},has:function(q,v){var t=c();return"string"===typeof v&&/^\d+$/.test(v)?Number(v)in t:v in q},ownKeys:function(){var q=c();return Object.keys(q).concat(Object.getOwnPropertyNames(Object.prototype))},
getOwnPropertyDescriptor:function(q,v){var t=c();return"string"===typeof v&&/^\d+$/.test(v)?{configurable:!0,enumerable:!0,value:t[Number(v)],writable:!0}:Object.getOwnPropertyDescriptor(q,v)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:p}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:p});"undefined"!==typeof b&&null==b._positionScriptLoadPromises&&
(b._positionScriptLoadPromises={});b.extractPageTextConfigs=f;b.loadPageTextInfo=function(q){var v,t,u,r,w,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.pageTextPositions||(b.pageTextPositions=[]),v=Array.isArray(q)?q:[q],t=[],u=!1,r=0;case 2:if(!(r<v.length)){D.jumpTo(4);break}w=v[r];if(!w||1>w){D.jumpTo(3);break}z={pageIndex:w,hasText:!1,
positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(g(w),7);case 7:b._pageReaderExtracted[w]||f(w);(A=c()[w-1])&&A.page===w&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,u=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+w+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:t.push(z);case 3:r++;D.jumpTo(2);break;case 4:return D.return({hasText:u,pageResults:t})}})};
b.hasPageText=function(q){b.pageTextPositions||(b.pageTextPositions=[]);var v=!Array.isArray(q),t=[],u=!1;q=$jscomp.makeIterator(v?[q]:q);for(var r=q.next();!r.done;r=q.next())if(r=r.value,!r||1>r)v||t.push({pageIndex:r,hasText:!1,positionCount:0});else{var w={pageIndex:r,hasText:!1,positionCount:0},z=r-1;(z=c()[z])&&z.page===r&&z.positions&&Array.isArray(z.positions)&&0<z.positions.length&&(w.hasText=!0,w.positionCount=z.positions.length,u=!0);if(v)return w.hasText;t.push(w)}return{hasText:u,pageResults:t}};
...
UserGroups?".yunzhan365.com":".fliphtml5.com")+";path=/")}function d(){for(var l={},m=window.location.search.substring(1).split("&"),p=0;p<m.length;p++){var q=m[p].split("="),v=decodeURIComponent(q[0]);q=q[1]?decodeURIComponent(q[1]):null;l[v]=q}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var m=16*Math.random()|0;return("x"===l?m:m&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026090301",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
function getArticleEditor(){function b(r){if(window.isExecuteGetInverseEditor)var w=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(w),r()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),r(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,r)},r,"")}function c(r,w,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",r);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?w&&w(D):"bookinfo"===F&&w?w():z&&z(w))};D.error=function(){z&&z(w)}}function d(r,w){u&&(clearTimeout(u),u=null);if(window.Module.isReady){var z=allocateUTF8(r.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);w();window.runArticleEditor&&delete window.runArticleEditor}else u=setTimeout(function(){d(r,w)},100)}function e(r){(window.articleListConfig=
r)?g(r):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(r){window.articleConfig=r.response})}function g(r){for(var w=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var D=A&&A.length&&A[F]?A[F].index:F,L=[],M=0;M<r.length;M++)(r[M].articles?r[M].articles:[]).forEach(function(I){if(I.isShowLinkSplited){if(I.articleTextList&&
...
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:w,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(r){r=JSON.parse(JSON.stringify(r));r.articleTextList.map(function(w){"text"===w.type&&
(w.text=w.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return w});return{articleId:r.articleId,newTime:r.newTime,title:r.title,subTitle:r.subTitle,author:r.author,categoryId:r.categoryId,articleTextList:r.articleTextList}}function l(r,w){var z=[];r.forEach(function(A){-1!==w&&(A.pageIndex===w||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===w}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,w),A.length&&(z=[].concat($jscomp.arrayFromIterable(z),$jscomp.arrayFromIterable(A)))):
z.push(A.rect))});return z}function m(r,w){var z="";r.forEach(function(A){if(-1!==w&&(A.pageIndex===w||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(D){return D.pageIndex===w}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,w):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,w)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function p(r){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,r,q):q(r)}function q(r){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,r,v):v(r)}function v(r){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var w=bookConfig.periodsConfigPath;w=w.replace("%periodicalId%",window.book_visit.periodicalId);c(w,r,t)}else t(r)}
function t(r){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,r):r&&r()}var u;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){return r.return(new Promise(function(w,z){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?w():window.runArticleEditor||window.inverseEditor?w():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(z=bookConfig.bookBaseURL)?(z.endsWith("/")||(z+="/"),c(z+"bookinfo.js",function(A){A&&A.response&&
...
v=0;v<canvasData[b].resources.length;v++)if(1!=canvasData[b].resources[v].type)q++,q>=canvasData[b].resources.length&&k();else{var t=new Image;t.src=getResource(b,v);t.alt="";globalImages[b][v]=t;t.onload=function(){q++;q>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,p,q;return $jscomp.asyncExecutePromiseGeneratorProgram(function(v){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(t){bookConfig.largePageWidth/bookConfig.largePageHeight>t[0].naturalWidth/t[0].naturalHeight?t.css({width:"auto",height:"100%"}):t.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)p=c[m],p=p.removeStartFrom("?"),q=$("<img alt='' style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),q.attr("src",p),k.append(q),q[0].onload=function(t){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},q[0].onerror=function(t){h++;h==c.length&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),q.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return m=dataBase64Str(b,c),h.$image=$("<img alt='' src='"+m+"'/>"),h.$image[0].onload=function(){d&&d(m,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),q.return();p=h;loadJavascript(k,function(v){var t=dataBase64Str(b,c,v);p.$image=$("<img alt='' src='"+
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),p=b.getContext("2d",{willReadFrequently:!0}),q=p.getImageData(0,0,f,g),v=p.createImageData(c,d);q=q.data;for(var t=v.data,u=0;u<d;u++)for(var r=0;r<c;r++){for(var w=4*(r+u*c),z,A=0,F=0,D=0,L=0,M=0,I=0,G=(u+.5)*k,O=Math.ceil((u+1)*k),K=Math.floor(u*k);K<O;K++){var J=Math.abs(G-(K+.5))/m,Q=(r+.5)*h;J*=J;for(var U=Math.ceil((r+1)*h),T=Math.floor(r*h);T<U;T++)if(z=
Math.abs(Q-(T+.5))/l,z=Math.sqrt(J+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var S=4*(T+K*f);I+=z*q[S+3];F+=z;255>q[S+3]&&(z=z*q[S+3]/250);D+=z*q[S];L+=z*q[S+1];M+=z*q[S+2];A+=z}}t[w]=D/A;t[w+1]=L/A;t[w+2]=M/A;t[w+3]=I/F}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(v,0,0)}
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,p,q){q=void 0===q?!1:q;var v=h[m],t=Math.abs(l-k);if(!(0>=t)){p=p?v.width:v.height;l=0;if(t>=p)for(l=Math.floor((t+c.spacing)/(p+c.spacing));0<l&&!(l*p+(l-1)*c.spacing<=t);)l--;if(!(0>=l)){t=1<l?(t-l*p)/(l-1):0;for(var u=0;u<l;u++){var r=q?k-u*(p+t):k+u*(p+t),w=void 0,z=void 0;switch(m){case "top":w=r+(v.width-c.width)/2;z=(v.height-c.height)/2+f;break;case "right":w=b.canvas.width-(c.width+v.width)/2-f;z=r+(v.height-c.height)/
2;break;case "bottom":w=r+(v.width-c.width)/2;z=b.canvas.height-(c.height+v.height)/2-f;break;case "left":w=(v.width-c.width)/2+f,z=r+(v.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,w,z,g[m],c,q)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,v){if(!b)return!1;var t=b.pageWidth,u=b.pageHeight,r=$.easing["easeInOut"+v],w=$.easing["easeOut"+v];v=w(null,p,g,b.toPoint.x-g,q);w=w(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(v=r(null,p,g,b.toPoint.x-g,q),w=bookConfig.FlipDirection?f*Math.sqrt(u*u-v*v):u-f*Math.sqrt(t*t-v*v));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:v,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",
...
{top:0,left:0};switch(b){case "top":k.top=c.top-g-h;k.left=c.left+(d-f)/2;break;case "bottom":k.top=c.top+e+h;k.left=c.left+(d-f)/2;break;case "left":k.top=c.top+(e-g)/2;k.left=c.left-f-h;break;case "right":k.top=c.top+(e-g)/2;k.left=c.left+d+h;break;default:k.top=c.top+e+h,k.left=c.left+(d-f)/2}return k},updatePosition:function(){function b(u){return m._computePositionForPlacement(u,c,d,e,f,g,h)}if(this.target&&this.tooltip){var c=this.target.offset(),d=this.target.outerWidth(),e=this.target.outerHeight(),
f=this.tooltip.outerWidth(),g=this.tooltip.outerHeight(),h=this.options.showArrow?8:0,k=this.getBoundaryRect(),l=this.options.placement,m=this,p=l;if("top"===l||"bottom"===l){p="top"===l?"bottom":"top";var q=b(l),v=b(p);if(m._rectFullyInside(q.left,q.top,f,g,k))p=l,l=q;else if(m._rectFullyInside(v.left,v.top,f,g,k))l=v;else{var t=m._intersectionArea(q.left,q.top,f,g,k);m._intersectionArea(v.left,v.top,f,g,k)>t?l=v:(p=l,l=q)}}else"left"===l||"right"===l?(p="left"===l?"right":"left",q=b(l),v=b(p),m._rectFullyInside(q.left,
q.top,f,g,k)?(p=l,l=q):m._rectFullyInside(v.left,v.top,f,g,k)?l=v:(t=m._intersectionArea(q.left,q.top,f,g,k),m._intersectionArea(v.left,v.top,f,g,k)>t?l=v:(p=l,l=q))):(l=b("bottom"),p="bottom");k=m._clampTooltipPosition(l.left,l.top,f,g,k);this._effectivePlacement=p;this.tooltip.css({top:k.top+"px",left:k.left+"px"});this.updateArrow(k)}},updateArrow:function(b){if(this.options.showArrow){b=this.tooltip.find(".tooltip-arrow");var c=null!=this._effectivePlacement?this._effectivePlacement:this.options.placement;
...
l/25)}.bind(this):function(){k=function(p,q){m(p,q,"Sine")}.animation(this,l)}.bind(this);var m=function(p,q,v){if(!b)return!1;var t=b.pageWidth,u=b.pageHeight,r=$.easing["easeInOut"+v],w=$.easing["easeOut"+v];v=w(null,p,g,b.toPoint.x-g,q);w=w(null,p,h,b.toPoint.y-h,q);b.dragMoveToFlip||(v=r(null,p,g,b.toPoint.x-g,q),w=bookConfig.FlipDirection?f*Math.sqrt(u*u-v*v):u-f*Math.sqrt(t*t-v*v));p<q?this.flipToPoint(b,c,d,b.fromPoint,{x:v,y:w}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
{x:m,y:p},q.rotateY?(q.$page[0].style.removeProperty("transform-origin"),d=void 0,v=transformCSS({scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})):(d=void 0,v=transformCSS({origin:g,scale:{x:m,y:p},perspective:6E3,rotateY:null!=(d=q.rotateY)?d:0})));q.setCSSByStyle(v);if(q.page.pageFlipShadow){var t=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});q.page.pageFlipShadow&&q.page.pageFlipShadow.setCSSByStyle(t)}}}return{x:m,y:p}}catch(u){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},
...
1,d);q=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(t){if(t){var u=transformCSS({tran:l?l:{x:0,y:0},scale:{x:p,y:q},origin:g});if(m.isCoverPage(t.pageIndex))if(t.tran=l?l:{x:0,y:0},t.scale={x:p,y:q},t.rotateY){t.$page[0].style.removeProperty("transform-origin");var r;u=transformCSS({scale:{x:p,y:q},perspective:6E3,rotateY:null!=(r=t.rotateY)?r:0})}else{var w;u=transformCSS({origin:g,scale:{x:p,y:q},perspective:6E3,rotateY:null!=(w=t.rotateY)?w:0})}t.setCSSByStyle(u);u=h?transformCSS({scale:{x:k.x/
p,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});t.page.pageFlipShadow&&t.page.pageFlipShadow.setCSSByStyle(u)}};for(d=0;d<b.length;d++){var v=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(v)}return{x:p,y:q}}catch(t){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(p,q){var v=l[q];if(v){v.width=p.width;v.height=p.height;p=p.toDataURL();var t=new Image;q=new Promise(function(u){t.onload=function(){v.getContext("2d").drawImage(t,0,0);u()};t.onerror=function(){return u()}});t.src=p;m.push(q)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){q&&q();g.print(l)}var p=b(l.doc).find("img"),q=h&&"function"===typeof h.onReady?h.onReady:null;if(0===p.length)m();else{var v=0;p.each(function(t,u){if(u.complete)v++,v===p.length&&m();else b(u).on("load error",function(){v++;v===p.length&&
