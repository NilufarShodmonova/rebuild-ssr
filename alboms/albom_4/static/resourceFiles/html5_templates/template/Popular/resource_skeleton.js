(function () {
  ...
  var publicResourceTemplateJsPath =
    "./static/resourceFiles/html5_templates/js/";
  var publicResourceJsPath =
    "./static/resourceFiles/js/";
  var publicResourceTemplateCssPath =
    "./static/resourceFiles/html5_templates/css/";
  var templateSourcePath =
    "./static/resourceFiles/html5_templates/template/Popular/";
  var yzReaderTemplatePath =
    "./static/resourceFiles/yzReader/templates/Slide/";

  function loadTemplate() {
    // 加载deString.js和jquery-4.0.0.min.js和book.min.js和app-theme.js
    // 默认携带时间戳参数，不需要手动添加
    dynamicLoading.load([
      `${publicResourceTemplateJsPath}deString.js`,
      `${publicResourceTemplateJsPath}jquery-4.0.0.min.js`, // 这个文件不需要时间戳
