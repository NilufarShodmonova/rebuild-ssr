...
hide:function(){this.visible&&(this.visible=!1,this.accessBox.removeClass("access-box-active"),this.accessBtn.attr("aria-expanded","false"),this.accessBtn[0].focus(),FormManager.unregister(this))},onResize:function(){},changeLanguage:function(a){this.previousPage.text(getLanguage("previousPageBtn","Previous page"));this.nextPage.text(getLanguage("nextPageBtn","Next page"));this.headText.text(getLanguage("accessibilityTitle","Text version of the book"));this.pageNum.find(".access-page-num-text").text(getLanguage("accessPageNum",
...
h.nextAddress)return b=bookConfig.btnShareWithEmailBody||"",c=bookConfig.btnShareWithEmailSubject||"",d=bookConfig.btnShareWithEmailTo||"",e=toAbsURL,h.yield(getPageDir(1,"thumb"),2);f=e(h.yieldResult);b=b.replaceAll("\\r\\n","\n",!0);b=b.replaceAll("\\n","\n",!0);b=b.replaceAll("\r\n","\n",!0);b=b.replaceAll("\n","\r\n",!0);b=b.replaceAll("{thumb}",f,!0);0<=b.indexOf("{link_no_page}")&&(b=b.replaceAll("{link_no_page}",window.location.href,!0));g=getShareUrlWithCurrentPageIfNeeded(window.location.href);
b=b.replaceAll("{link}",g);b=b.replaceAll("{title}",window.document.title,!0);c&&(c=c.replaceAll("{title}",window.document.title,!0));d&&(d=encodeURIComponent(d));c&&(c=encodeURIComponent(c));b&&(b=encodeURIComponent(b));a.emailStr="mailto:"+d+"?subject="+c+"&body="+b;a.$button.attr("href",a.emailStr);h.jumpToEnd()})},onClick:function(a){}}).extend("ToolbarButton");
...
f,!0);b=b.replaceAll("{link}",share_url,!0);b=b.replaceAll("{title}",window.document.title,!0);c&&(c=c.replaceAll("{title}",window.document.title,!0));d&&(d=encodeURIComponent(d));c&&(c=encodeURIComponent(c));b&&(b=encodeURIComponent(b));window.open("mailto:"+d+"+?subject="+c+"&body="+b,"_blank");g.jumpToEnd()})}}).expand(PhoneToolbarButtons).extend("ToolbarButton");
